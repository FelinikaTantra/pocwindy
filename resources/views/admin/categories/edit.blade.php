...
<div class="bg-white rounded-lg shadow-sm p-6 max-w-2xl">
    ...
    <form action="{{ route('admin.categories.update', $category->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" id="name" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 border p-2" value="{{ old('name', $category->name) }}" required>
            @error('name')

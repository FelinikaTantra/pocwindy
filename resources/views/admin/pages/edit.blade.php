...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">Edit Page: {{ $page->title }}</h2>
    ...
    <form action="{{ route('admin.pages.update', $page) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" id="title" value="{{ $page->title }}" class="shadow-sm border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
